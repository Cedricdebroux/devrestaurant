      ...
      <div class="footer row">
        <div class="col-lg-3 col-md-6 col-sm-12 mb-2"><?php dynamic_sidebar('footer-area-one');?> 
          <div class="row row-cols-4">
            ...
            <div class="col">
              <svg xmlns="http://www.w3.org/2000/svg" width="11.143" height="10.648" viewBox="0 0 11.143 10.648">
                <defs>
                  <style>
                    .cls-1 {
                      fill: #fff;
            ...
            <div class="col">
              <svg xmlns="http://www.w3.org/2000/svg" width="6.267" height="12.072" viewBox="0 0 6.267 12.072">
                ...
                <path id="facebook" class="cls-1" d="M-1864.1,4226.089a12.064,12.064,0,0,1,1.654.087v1.915h-1.139a1.062,1.062,0,0,0-.841.262,1.2,1.2,0,0,0-.218.783v1.371h2.126l-.283,2.147h-1.843v5.507h-2.22v-5.507h-1.849v-2.147h1.849v-1.581a2.81,2.81,0,0,1,.755-2.094,2.741,2.741,0,0,1,2.009-.743Z" transform="translate(1868.716 -4226.089)"/>
              </svg>
            </div>
            <div class="col">
              <svg xmlns="http://www.w3.org/2000/svg" width="11.143" height="11.144" viewBox="0 0 11.143 11.144">
                <defs>
                  <style>
                    .cls-1 {
                      fill: #fff;
