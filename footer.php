      ...
      <div class="footer row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 mb-2 text-center">
          <div class="h5"><?php the_title();?></div>
            <div class="row">
              <svg class="col" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 17.979 17.979">
              ...
              </svg> <p class="col mr-2">Mondays ---- <?php the_field('monday');?></p>
            </div>
            <div class="row">
              <svg class="col" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 17.979 17.979">
                <g id="time-clock" transform="translate(-1 -1)">
              ...
              </svg> <p class="col mr-2">Tue - Fri ---- <?php the_field('tue_fri');?></p>
            </div>
            <div class="row">
              <svg class="col" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 17.979 17.979">
                <g id="time-clock" transform="translate(-1 -1)">
              ...
              </svg> <p class="col mr-2">Sat - Sun  ---- <?php the_field('sat-sun');?></p>
            </div>
            <div class="row">
              <svg class="col" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 17.979 17.979">
                <g id="time-clock" transform="translate(-1 -1)">
              ...
              </svg> <p class="col mr-2">Public Holidays---- <?php the_field('public_holidays');?></p>
            </div>
