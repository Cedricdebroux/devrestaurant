            ...
            <div class="recipeSinglePageHeader"> <!-- Back, date, taxonomy V -->
              <div class="recipeSinglePageHeaderList pt-3">
                ...
                <p class="ml-4"><?php echo get_the_date( 'j F, Y' ); ?></p>
                      ...
                      <!-- test taxonomy -->
                      <p class="d-flex justify-content-end"><img id="cutelry" src="https://teamperfect.bout-de-creations.com/wp-content/uploads/2021/01/cutelry-1.svg" alt=""><?php the_terms( $post->ID, 'recipe_types' ); ?> </p>           
              </div>
